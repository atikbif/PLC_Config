#include "dialogtemperatureconfig.h"
#include "ui_dialogtemperatureconfig.h"

DialogTemperatureConfig::DialogTemperatureConfig(const AIConfig::State &state, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DialogTemperatureConfig)
{
    ui->setupUi(this);
...
AIConfig::State DialogTemperatureConfig::getAIState() const
{
...
DialogTemperatureConfig::~DialogTemperatureConfig()
{
    delete ui;
}
