#include "dialogfrequencyconfig.h"
#include "ui_dialogfrequencyconfig.h"

DialogFrequencyConfig::DialogFrequencyConfig(const AIConfig::State &state, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DialogFrequencyConfig)
{
    ui->setupUi(this);
...
AIConfig::State DialogFrequencyConfig::getAIState() const
{
...
DialogFrequencyConfig::~DialogFrequencyConfig()
{
    delete ui;
}
